...
const ItemsModel 	= require(__path_schemas + 'khoa');
const ValidateItems	= require(__path_validates + 'khoa');
const UtilsHelpers 	= require(__path_helpers + 'khoa');
const ParamsHelpers = require(__path_helpers + 'params');

const linkIndex		 = '/' + systemConfig.prefixAdmin + '/khoa/';
const pageTitleIndex = 'Item Management';
const pageTitleAdd   = pageTitleIndex + ' - Add';
const pageTitleEdit  = pageTitleIndex + ' - Edit';
const folderView	 = __path_views + 'pages/khoa/';
